...
| 도구 | 무엇 |
|---|---|
| `detect_anomaly` | **2일차에 내가 짠 `detect()`** 를 에이전트가 부를 수 있게 |
...
**어떤 도구를 어떤 순서로 부를지는 말하지 않습니다.** AI 가 방금 만든 도구들을
줄줄이 이어서 호출하며 리포트를 뽑아냅니다. 도구는 **내 컴퓨터에서** 실행되고,
강사 서버는 「어느 도구를 부를지」만 중계합니다 — 내 PC 에 AI 키를 두지 않습니다.
