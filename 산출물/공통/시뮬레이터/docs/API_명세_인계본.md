...
| 구간 | 인증 | 이유 |
|---|---|---|
| **읽기 API (1일차)** | **없음** | Day 1 Step 1 의 진입장벽을 없애기 위한 결정입니다. 네임스페이스 이름만 알면 읽힙니다 |
...
> **제어 API 4종은 1일차 에 잠겨 있습니다.** 호출하면 `403` 과 함께
> *"제어 API 는 아직 잠겨 있습니다. 교안상 2일차 에 개방됩니다."* 가 돌아옵니다.
...
Day 1 에 강사가 결측을 주입하지 않더라도, 시드에 넣어 두면 1일차 까지 같은 대시보드를 씁니다.
...
- 온도는 rpm 의 함수입니다. 2일차 에 감속하면 온도가 실제로 내려갑니다
