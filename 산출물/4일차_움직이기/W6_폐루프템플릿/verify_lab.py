...
교안 Day 4 가 요구하는 것이 이 템플릿 위에서 실제로 성립하는지 확인한다.
...
def part_detect() -> None:
    print("\n2. 감지 — Day 3 의 한계를 Day 4 에서 넘는가 (W5 와 같은 0.5℃/h 기울기)")
    ...
    try:
        ...
        print(f"  [건너뜀] Lab 3-2 정답을 못 읽어 대조 생략 — {type(exc).__name__}")
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("전 항목 통과 — Day 4 폐루프가 이 템플릿 위에서 성립합니다.")
    return 0
