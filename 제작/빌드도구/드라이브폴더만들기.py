...
def main() -> int:
    ...
    #    실습 가이드는 **한 권**이다. 이틀치를 갈라 두면 학생이 이틀 내내
    #    「지금은 어느 걸 여나」를 한 번 더 판단해야 한다.
    문서 = [
        (REPO / "강의" / "준비안내.md",
