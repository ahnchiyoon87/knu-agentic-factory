...
대상 = {
    ...
    "만들기_02_블록": [
        # 완성본 화면에 있는 것은 만들기 단계에도 있어야 한다 —
        # 이 설명 세 줄이 빠져 있어서, 따라 해도 완성본과 다른 것이 나왔다
        ("설명세줄",   ["수업을 듣고 온 날, 카드를 만듭니다."]),
        ("콜아웃",     ["📌", "내가 이해한 걸 먼저 쓴다."]),
        ("제목2",      ["수업 기록"]),
    ],
    "만들기_04_표메뉴": [
    ...
    "만들기_05_유형": [
        ("선택",       ["◐", "선택 ✓"]),
        ("다중선택",   ["≔", "다중 선택"]),
        # 완성본 카드에 「🕐 날짜」가 있다 — 목록의 「생성 일시」를 골라 이름만 바꾼 것
        ("생성일시",   ["🕐", "생성 일시"]),
    ],
    "만들기_05_옵션": [
        ("옵션셋",     ["설명못함", "대충앎", "설명가능"]),
    ...
    "만들기_09_코드": [
        # 코드 블록과 언어 이름표는 서로 붙어 있다 — 따로 치면 테두리가 겹친다
        ("코드블록",   ["roll = s.rolling(window=60)", "Python ▾"]),
        ("그림자리",   ["강의자료 캡처"]),
    ],
    "만들기_10_체크": [
    ...
    "만들기_12_남은것": [
        # 탭과 그 옆 필터 표시는 나란히 붙어 있다 — 한 상자로 묶는다
        ("탭과필터",   ["🔁 남은 것", "필터: 이해도 ≠ 설명가능"]),
        ("개수줄",     ["2개 · 여기가 비면 끝난 것"]),
    ],
    "만들기_13_공유": [
        ("게시탭",     ["게시"]),
