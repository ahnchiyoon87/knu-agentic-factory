...
def main() -> int:
    ...
    print("\n" + "=" * 74)
    print(f"이번 판   찾아낸 이상 3종 중 {caught}종   ·   오탐 하루 {per_day:.0f}번")
    print("-" * 74)

    if caught == 0:
        print("  이상을 하나도 못 찾고 있습니다. 오탐이 적은 것은 그 때문입니다.")
    else:
        print("  목표 —  찾아낸 개수를 그대로 둔 채, 오탐을 하루 30번 아래로")
        print()
        print("  ※ 오탐만 줄이는 것은 쉽습니다. k 를 크게 올리면 거의 안 울립니다 —")
        print("    이상을 못 찾아서 그렇습니다. 위 두 숫자를 반드시 같이 보세요.")
    print()
